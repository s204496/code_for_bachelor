...
"""
def newton_rapson_iter(out_file, g, h_s, h_l, h_r, u_l, u_r, a_l, a_r, tolerance, max_iterations):
    h_spre = h_s 
    h_s = h_s # just for scoping reasons
    iter = 0
...
"""
def initial_guess(g, h_l, h_r, u_l, u_r, a_l, a_r):
    h_min = min(h_l, h_r)
