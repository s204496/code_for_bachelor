...
def main(terminal_arguments):
    ...
    for cells in cells_list:
        ...
        (U,W) = tvd_waf.entire_domain("", "", False, x_len, break_pos, g, cells, riemann_int, riemann_str, tolerance, iterations, t_end, W_l, W_r)
        end_time = time.time()
    ...
    plotter.plot_error_and_speed(speed_list, error_list, delta_x_list, cells_list, os.path.splitext(terminal_arguments[1])[0], "output/speed_and_accuracy/tvd_waf", "tvd_waf", riemann_str)
